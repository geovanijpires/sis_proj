        ...
        <div class="container">
            <div class="well well-lg">
                <form class="form-inline">
                  ...
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <div class="form-group">
                        <label for="select_rel_user">Funcionário</label>
                        <select id="select_rel_user" class="form-control">
                            <?php

                            $id_func = $_SESSION["id_func"];

                            $query = "Select id,nome from funcionario order by nome";
                            $consulta = mysqli_query($con,$query);
                            while ($resultado_consulta = mysqli_fetch_array($consulta)) {
                                if ($resultado_consulta['id'] == $id_func) {
                                    echo '<option value=' . $resultado_consulta['id'] . ' selected>' . $resultado_consulta['nome'] . '</option>';
                                }else {
